...
This is a template for creating ROS 2 packages. 

**<em>Note: </em>** If you do not have ROS 2 installed you can use my Docker Container.
...
- <strong>my_bot_ros2</strong>: Built on top of <strong>galactic_tb_env</strong> image to set up the ros2_ws for developing the KouBot project.
