...
def generate_launch_description():
    ...
    robot_state_publisher_node = Node(
        ...
        parameters=[{'robot_description': launch_ros.descriptions.ParameterValue(Command(['xacro ',os.path.join('src',package_description,'urdf/base/my_bot_base.xacro')]), value_type=str)  }],
        output="screen"
    )
